...
            if (!t) return;
            let o = e.target.getAttribute("version") |
| i;
            s && (s.remove(), s = null);
...
| s && s.contains(t.relatedTarget) |
| (clearTimeout(c), r && (r.remove(), s = null))
            })), r.addEventListener("mouseleave", (t => {
                r && r.contains(t.relatedTarget) |
| t.relatedTarget === e.target |
| s && s.contains(t.relatedTarget) |
| (clearTimeout(c), r.remove(), s = null)
            })), e.target.addEventListener("mouseleave", (t => {
                r && r.contains(t.relatedTarget) |
| t.relatedTarget === e.target |
| s && s.contains(t.relatedTarget) |
...
                e.nodeType === Node.TEXT_NODE? E(e) : e.nodeType!== Node.ELEMENT_NODE |
| ["script", "style", "iframe", "noscript"].includes(e.tagName.toLowerCase()) |
| w(e)
            }))
        }
        if ("false"!== r) {
